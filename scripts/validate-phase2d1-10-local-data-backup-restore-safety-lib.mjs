...
function validateNoRedLines() {
  ...
  const allowedPatterns = [
    ...
    /^scripts\/phase2d(?:9-local-data-backup-restore-safety-acceptance|19-import-restore-review-flow-acceptance|29-import-restore-ui-facing-data-hardening|30-disabled-import-restore-ui-shell-acceptance|39-local-import-restore-preview-harness-acceptance|40-import-restore-ui-action-abuse-hardening|41-import-restore-accessibility-regression-acceptance|42-import-restore-route-navigation-blocker-validation|52-routeless-import-restore-ui-interaction-acceptance|53-import-restore-visual-copy-regression-acceptance|54-import-restore-wiring-final-blockers|66-local-data-safety-corpus-regression-acceptance)\.test\.ts$/,
