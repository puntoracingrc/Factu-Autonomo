...
const practicalSubtitleByCode: Readonly<Record<string, string>> = Object.freeze(
  {
    ...
    "113": "Comunicación del impuesto de salida al trasladarse a la UE o al EEE",
    ...
    "171": "Operaciones relevantes de efectivo informadas por entidades financieras",
    ...
    "185": "Cotizaciones mensuales comunicadas por Seguridad Social y mutualidades",
    ...
    "213": "Inmuebles españoles de determinadas entidades en jurisdicciones no cooperativas",
