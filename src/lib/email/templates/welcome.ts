...
Tu cuenta ya está confirmada. Este mensaje de Factu es solo de bienvenida.
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background-color:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #e2e8f0;box-shadow:0 10px 30px rgba(15,23,42,0.06);">
            ...
            <tr>
              <td style="padding:8px 32px 28px;font-size:16px;line-height:1.65;color:#334155;">
                ...
                <p style="margin:0 0 16px;padding:12px 14px;border-radius:12px;background:#ecfdf5;border:1px solid #a7f3d0;color:#065f46;font-size:14px;"><strong>Cuenta confirmada:</strong> este correo de Factu es solo bienvenida.</p>
                <p style="margin:0 0 24px;">Crea tu primera factura de prueba (en borrador, para que Hacienda no se entere todavía):</p>
