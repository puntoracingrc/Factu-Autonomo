// Generated from the official INE municipality register. Do not edit entries by hand.
export const SPAIN_MUNICIPALITIES_SOURCE = {
...
export const SPAIN_MUNICIPALITIES_BY_PROVINCE: Readonly<
