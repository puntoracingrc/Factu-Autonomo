...
describe("DOCUMENT_READING_LIMITS_V1", () => {
  it("mantiene congelados los límites de la fase 0", () => {
    expect(DOCUMENT_READING_LIMITS_V1).toEqual({
    ...
    expect(Object.isFrozen(DOCUMENT_READING_LIMITS_V1)).toBe(true);
  });
});
