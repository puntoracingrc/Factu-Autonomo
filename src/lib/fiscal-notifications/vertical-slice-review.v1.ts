...
const DATE_LABEL: Readonly<Record<ProceduralDateTypeV1, string>> =
  Object.freeze({
    ...
    APPEARANCE_PERIOD_START: "Inicio de comparecencia",
    APPEARANCE_PERIOD_END: "Fin de comparecencia",
    CERTIFICATE_ISSUE_DATE: "Fecha del certificado",
    UNDERLYING_ACT_DATE: "Fecha del acto citado",
