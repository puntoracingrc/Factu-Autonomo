...
export const AEAT_P0_RELATION_RULES_V10 = Object.freeze([
  ...
  rule("PRECEDES_REFUND_PAYMENT", ["assessment.rectification_resolution"], ["refund.payment_communication"], [["REFUND_REFERENCE", "ACT_ID"], ["AMOUNT"]], ["MODEL", "TAX_PERIOD", "AMOUNT"], "La comunicación posterior informa del pago o aplicación de la devolución reconocida en esta resolución.", "Puede corresponder a la devolución reconocida; revisa la referencia.", "Resolución favorable no equivale a transferencia."),
