  ...
  const expenses: Expense[] = [
    {
      ...
      workDocumentId: "demo-invoice-1",
      purchaseLines: [
        {
          id: "demo-expense-materiales-line-1",
          description: "Material técnico para la instalación",
          quantity: 2,
          unit: "ud",
          unitPrice: 24.2,
          ivaPercent: 21,
        ...
        {
          id: "demo-expense-materiales-line-2",
          description: "Fijaciones y accesorios del trabajo",
          quantity: 2,
          unit: "ud",
          unitPrice: 12.1,
          ivaPercent: 21,
        ...
        {
          id: "demo-expense-materiales-line-3",
          description: "Consumibles de oficina no usados en este trabajo",
          quantity: 1,
          unit: "ud",
          unitPrice: 12.1,
          ivaPercent: 21,
