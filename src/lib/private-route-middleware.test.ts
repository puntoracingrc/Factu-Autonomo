...
describe("private route middleware", () => {
  ...
  it("retira noindex únicamente del índice y las ciento cuarenta y una fichas contrastadas", () => {
    expect(PUBLIC_AEAT_OFFICIAL_INDEXABLE_PATHS_V1).toHaveLength(142);
