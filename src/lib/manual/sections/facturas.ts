  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Si has completado **Ajustes → Mi gestor**, **Exportar y enviar al gestor** descarga exactamente el mismo ZIP y abre un correo dirigido a esa persona, con el asunto y el resumen del periodo ya escritos. Por seguridad del navegador el ZIP no se adjunta automáticamente: revisa el correo y adjunta el archivo recién descargado antes de enviarlo.",
