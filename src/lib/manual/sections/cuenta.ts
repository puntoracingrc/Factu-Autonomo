  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Si **Cuenta → Importación** detecta documentos de importadores históricos conocidos que quedaron bloqueados durante el despliegue de integridad, muestra una **vista previa** por origen. Descarga antes una **copia JSON** y usa la **confirmación explícita** solo si reconoces esos archivos. El estado **Histórico importado · aceptado por ti** los congela y permite usarlos en **impuestos y rentabilidad**, pero no crea un sello moderno ni un registro Veri*Factu de Factu. **Conserva el archivo original**: los casos ambiguos, rectificativas, recibos o evidencia corrupta quedan fuera y no se cambian automáticamente. Si necesitas deshacer la reparación, restaura la copia JSON previa: la restauración sustituye el workspace completo por ese estado anterior.",
      ],
    },
    {
