  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "El reconocimiento automático y local cubre las **87 familias documentales** de la guía: notificaciones, información y certificados, censos, requerimientos, comprobaciones y liquidaciones, sanciones, aplazamientos, recaudación, compensaciones y devoluciones, pagos, embargos, recursos, responsabilidad, inspección y resoluciones censales. Cada familia tiene título cerrado, campos propios, fuentes y explicación; todas las fichas siguen requiriendo revisión humana.",
        "En una denegación de aplazamiento o fraccionamiento, la ficha separa el motivo impreso, el importe solicitado, las deudas y claves relacionadas, la fecha del acuerdo, el lugar de pago, el plazo literal, las consecuencias de no pagar y las vías de recurso. La carta de pago adjunta se trata como otro documento del mismo PDF y nunca como justificante de que el ingreso ya se haya realizado.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "**Relaciones entre documentos** comprueba identificadores administrativos exactos como expediente, liquidación, deuda, notificación o registro. El catálogo conoce 15 cadenas procedimentales y 48 tipos de relación. Solo marca una dirección exacta cuando coinciden la referencia, el ámbito, el emisor y una transición declarada; en los demás casos muestra **Relación detectada · revisar**. Incluso una relación exacta vincula fichas, pero no confirma por sí sola el efecto, el pago, la extinción de una deuda ni el cierre del expediente.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Las **87 fichas** están explicadas y tienen lectura automática con revisión obligatoria. Las cadenas cubren, entre otras, notificación y requerimiento, propuesta y liquidación, sanción, aplazamiento y cuotas, devolución y compensación, pago, apremio, embargo, contestación, ingreso y levantamiento. Una carta de pago no acredita el ingreso; un justificante debe identificar la operación; un pago fallido no confirma por sí solo si la deuda sigue abierta.",
