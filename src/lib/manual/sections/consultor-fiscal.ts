  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Toda coincidencia permanece como **Revisión humana obligatoria**. En una providencia reconocida puede mostrar durante la revisión importes, valores exactos de referencias y fechas que figuran bajo etiquetas cerradas; todo ello es efímero y no se guarda. Una fecha impresa no se interpreta como fecha de notificación ni como vencimiento, y **Vto.** se mantiene como referencia opaca, nunca como fecha o cuota. El sistema no determina obligado, expediente u obligaciones y nunca crea deudas, plazos, pagos, gastos o asientos.",
