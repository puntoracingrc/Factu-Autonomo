  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "El reconocimiento actual cubre providencias de apremio, concesiones y denegaciones de aplazamiento o fraccionamiento, acuerdos de compensación, cartas o documentos de pago, diligencias de embargo, requerimientos formales de presentación, requerimientos de documentación y acuerdos de alta en el ROI.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "La primera cadena explicada cubre la entrega de una notificación, requerimientos, inicio y resultado de una comprobación, denegación de aplazamiento o fraccionamiento, carta de pago, justificante, pago fallido, providencia de apremio y las principales diligencias de embargo. Una carta de pago no acredita el ingreso; un justificante debe identificar la operación; un pago fallido no confirma por sí solo si la deuda sigue abierta.",
