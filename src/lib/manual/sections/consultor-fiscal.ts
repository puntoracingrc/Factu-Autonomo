  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Tras el análisis puedes pulsar **Guardar ficha técnica local**. Es una acción opcional: solo conserva en este navegador, y separada por cuenta, la traza técnica necesaria para volver a ver el resultado. No se sincroniza con la nube ni guarda nombre, NIF, CSV, referencias, importes, fechas impresas, plazos o contenido del documento.",
        ...
        "Toda coincidencia permanece como **Revisión humana obligatoria**. En una providencia reconocida muestra el nombre o razón social, el NIF y la condición de **obligado al pago** cuando aparecen juntos bajo la sección impresa **Identificación del obligado al pago**; también puede mostrar importes, valores exactos de referencias y fechas bajo etiquetas cerradas. Todo ello es efímero y no se guarda. Una fecha impresa no se interpreta como fecha de notificación ni como vencimiento, y **Vto.** se mantiene como referencia opaca, nunca como fecha o cuota. La condición impresa describe el documento: no compara el NIF con la cuenta, no verifica la autenticidad y nunca crea deudas, plazos, pagos, gastos o asientos.",
