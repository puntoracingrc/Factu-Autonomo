  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Las **122 fichas** están explicadas: 118 tienen lectura automática con revisión obligatoria y 4 sectoriales están disponibles para consulta manual. Las incorporaciones nuevas conservan visible que el significado oficial está modelado, pero la estructura concreta del PDF aún necesita una muestra documental antes de considerarse firma fuerte. Una solicitud de ampliación no cambia el plazo sin acuerdo; una solicitud de rectificación no implica estimación; un recurso no implica suspensión; una adjudicación no prueba la extinción total; y una respuesta técnica VERI*FACTU no es una sanción ni un requerimiento.",
