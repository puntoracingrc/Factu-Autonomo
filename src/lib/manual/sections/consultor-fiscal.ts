  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Cada tarjeta del listado incluye una papelera. **Eliminar ficha de Factu** borra únicamente los datos estructurados locales de esa ficha y sus vínculos locales después de una confirmación. Si existen datos operativos dependientes, la eliminación se bloquea para evitar un borrado parcial.",
        "Google Drive es independiente: eliminar la ficha en Factu no elimina, mueve ni modifica el original archivado. Cuando existe un original en Drive, la confirmación permite abrirlo para que el usuario decida allí qué quiere hacer con su archivo.",
      ],
