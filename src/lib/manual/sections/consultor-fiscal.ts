  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Pulsa **Guardar datos en mi cuenta** solo después de revisar la ficha. Factu conserva por cuenta los datos estructurados y su procedencia; no guarda el PDF, su nombre ni el texto completo. Nunca guarda el PDF, su nombre ni el texto completo. La ficha entra en la sincronización y en las copias de seguridad de los datos de la cuenta.",
        "Una fecha impresa no se interpreta como fecha de notificación ni como vencimiento. Un plazo escrito se conserva literalmente y **Vto.** se mantiene como referencia opaca, nunca como fecha o cuota. Un importe no crea automáticamente una deuda, un pago, un gasto o un asiento. El panel **Antes de actuar** enumera comprobaciones manuales y no guarda su progreso. Solo ante una coincidencia única y completa puede ofrecer un enlace a información general del procedimiento en la AEAT; abrirlo es una decisión del usuario, no valida el PDF ni calcula plazos.",
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Al abrir una ficha completa verás los datos estructurados, los documentos del mismo expediente y la explicación de cada vínculo. Si falta el original, la ficha indica que debes volver a seleccionarlo para archivarlo; si está en Drive, ofrece **Abrir o descargar**.",
      ],
