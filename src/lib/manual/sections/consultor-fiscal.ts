...
export const consultorFiscalSection: ManualSection = {
  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        "Abre cada resultado del lote. La revisión previa utiliza el mismo informe limpio que verás después de guardar: identificación, datos observados por página, importes, explicación práctica, relaciones y fuentes. La ficha puede mostrar tipo de documento, organismo, roles de los intervinientes sin su identidad, referencias administrativas seguras, importes, fechas impresas, documentación solicitada, plazo literal y consecuencias expresas, siempre que aparezcan bajo una estructura reconocida. Los campos conservan página, etiqueta y procedencia para poder contrastarlos con el PDF.",
        ...
        "Si hay varias fichas listas, **Guardar todo** las persiste una a una sobre el estado más reciente de la cuenta. Si una escritura falla, conserva en la cola esa ficha y todas las posteriores para reintentarlas; las anteriores que ya superaron la comprobación durable permanecen guardadas. El lote nunca avanza sobre un resultado fallido como si se hubiera guardado.",
    ...
    },
    {
      ...
      paragraphs: [
        "La biblioteca **Tus documentos** reúne las fichas guardadas y las cadenas que pertenecen al mismo expediente. Cada tarjeta resume únicamente familia, título, organismo abreviado, fecha documental, referencia principal, hasta dos importes si existen, revisión y disponibilidad de un original anterior en Drive. **Abrir ficha** lleva al informe individual con el mismo lenguaje visual. De forma provisional, las fichas guardadas sin recargar la pantalla muestran también el nombre del archivo que las originó; un PDF con varios actos conserva la asociación con todas sus fichas.",
        "Puedes buscar por título, familia, organismo, expediente, referencia, modelo o periodo. El panel **Filtros** permite acotar por familia, organismo, año, periodo, revisión, relaciones, original y próximo vencimiento. La ordenación mueve cada expediente completo por su primer documento, último documento, fecha más reciente o antigua, próximo vencimiento o revisión pendiente; nunca separa sus fichas.",
        "Debajo de los filtros, el bloque provisional **Archivos guardados en esta sesión** reúne esos nombres y permite copiarlos para una comprobación externa. Los nombres históricos no se reconstruyen ni se inventan: al recargar la pantalla desaparecen porque no forman parte de la ficha persistente.",
        "**Revisar fichas y relaciones con GPT-4o** envía bajo consentimiento explícito todas las fichas estructuradas, sus datos observados y páginas, fechas, referencias protegidas, importes, explicaciones, fuentes y relaciones. Los documentos, sujetos, referencias y archivos se sustituyen por alias antes de salir del navegador; la pantalla vuelve a asociar cada alias con su ficha y, cuando está disponible en la sesión, con su nombre de archivo. La revisión solo muestra posibles incoherencias y propuestas: nunca edita fichas, crea relaciones ni ejecuta cambios.",
        "Los documentos relacionados permanecen juntos y con la misma escala. En escritorio forman una cadena horizontal con desplazamiento dentro de su fila; en móvil forman una cronología vertical. Siempre se ordenan por la fecha que figura en el documento. Si incorporas después un acto anterior, aparece en su posición cronológica, y los documentos sin fecha quedan al final sin convertir todo el intervalo en **Fecha pendiente**.",
        "Los conectores continuos identifican relaciones confirmadas por una referencia compatible; los discontinuos indican **Relación sugerida**. Pulsa el conector para consultar el tipo, el documento origen, el documento destino y el identificador coincidente. Los 48 tipos de relación y las 15 cadenas procedimentales anteriores se conservan, y se añaden 11 cadenas para rectificación, ampliación de plazo, REDEME/SII, certificados, ejecución, apoderamientos, notificación electrónica, subastas, devolución bancaria y cierre sancionador. Un importe, un nombre o la proximidad de fechas no confirman una relación. Incluso una coincidencia exacta vincula fichas, pero no confirma por sí sola el efecto, el pago, el saldo o el cierre del expediente.",
        "Al abrir una ficha completa verás los datos impresos, sus páginas de procedencia, la explicación en lenguaje normal, importes, cronología, relaciones y fuentes oficiales que realmente correspondan. Si existe un original archivado anteriormente, la ficha permite abrirlo en Drive; si no existe, no muestra una acción ficticia ni pide volver a seleccionarlo.",
        "Cada tarjeta incluye una papelera que actúa solo sobre esa ficha. Sin original en Drive, la confirmación pregunta **¿Eliminar este documento?**. Si existe un original verificado y exclusivo, pregunta **¿Quieres eliminar también el documento original subido a Google Drive?** y puedes elegir **Solo ficha**, **Ficha y original** o **Cancelar**. Al borrar una ficha se conservan las demás y el dominio vuelve a calcular únicamente las relaciones que sigan siendo válidas.",
        "El control provisional **Borrar todas las fichas** requiere confirmación y prepara primero la eliminación completa en memoria. Solo sustituye el estado cuando toda la operación puede persistirse de forma durable; si existe un bloqueo o falla la escritura, conserva el listado intacto. El borrado elimina fichas estructuradas y sus relaciones, pero no borra originales archivados anteriormente en Google Drive.",
        "La opción de Drive nunca borra permanentemente el archivo: comprueba que es el PDF exacto creado por Factu, lo mueve a la papelera de Drive y verifica el resultado. Si la ficha no puede eliminarse después, Factu intenta restaurar el original. Un PDF compartido por varias fichas se conserva en Drive y no ofrece borrado remoto desde una sola tarjeta. Los datos operativos dependientes siguen bloqueando cualquier eliminación parcial.",
      ],
