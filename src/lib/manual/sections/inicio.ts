  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Con **Pro** los recordatorios «Para oficina» se sincronizan en hasta 2 dispositivos; con **Pro+**, hasta en 5. En Gratis permanecen en el dispositivo donde se crean.",
      ],
      screenshot: {
