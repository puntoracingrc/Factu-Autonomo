...
-- Rectified and voided invoices remain operationally visible so every device
-- can receive collection and relationship updates created around rectification.
...
comment on function public.list_central_invoice_events_v1(
  ...
  'CENTRAL_INVOICE_AUTHORITY_CLOSED_DOCUMENT_EVENT_PULL_V1 service-role-only event pull including issued, rectified and voided invoices.';
