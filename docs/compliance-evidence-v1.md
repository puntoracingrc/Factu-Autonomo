...
- proximos pasos posibles: pausa de revision tecnica, security review externa, revision UX/legal/data-loss, decision explicita de hidden UI enablement o hardening adicional antes de ampliar superficie.
