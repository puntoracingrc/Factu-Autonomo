...
# Revisión fiscal · es-common.2025.model-349

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-349`
...
- `es-common.2025.model-349.exclusion-1` · Alta en ROI sin operaciones · `ADVISORY_EXCLUSION_CANDIDATE`
- `es-common.2025.model-349.exclusion-2` · Operaciones excluidas del concepto informable · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `349.2025.positive`
- Declarada: `349.2025.negative`
- Declarada: `349.2025.exception`
- Declarada: `349.2025.incomplete`
- Declarada: `349.2025.census-mismatch`
- Declarada: `349.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-349` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:adbf71e1314fd476a1ca62d8c805a72e8f4236d77dc4095c18defd27f5b99a7c`
