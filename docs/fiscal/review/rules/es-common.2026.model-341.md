...
# Revisión fiscal · es-common.2026.model-341

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2026.model-341`
...
- Descripción de la decisión: Declaración especial a revisar

## Condiciones de inclusión

- Reintegro de compensaciones en el régimen agrario

## Candidatos de exclusión

- `es-common.2026.model-341.exclusion-1` · No existe el supuesto especial · `ADVISORY_EXCLUSION_CANDIDATE`

## Excepciones

- No existe el supuesto especial
...
- `aeat.model-341.instructions` · Modelo 341 · instrucciones · https://sede.agenciatributaria.gob.es/Sede/todas-gestiones/impuestos-tasas/iva/modelo-341-iva-egimen-especial-pesca_/instrucciones.html · snapshot pendiente
...
- Declarada: `341.2026.positive`
- Declarada: `341.2026.negative`
- Declarada: `341.2026.exception`
- Declarada: `341.2026.incomplete`
- Declarada: `341.2026.census-mismatch`
- Declarada: `341.2026.year-boundary`
...
- `fiscal-closure.es-common.2026.model-341` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:fb6fbdab08f24ee031aa87651243a2e7a58d2a1bc2314a1a8567a91f8cbc5581`
