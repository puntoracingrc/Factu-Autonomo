...
# Revisión fiscal · es-common.2025.model-115

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-115`
...
- `es-common.2025.model-115.exclusion-1` · Exoneración u otra excepción acreditada · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `115.2025.positive`
- Declarada: `115.2025.negative`
- Declarada: `115.2025.exception`
- Declarada: `115.2025.incomplete`
- Declarada: `115.2025.census-mismatch`
- Declarada: `115.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-115` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:db13c857558c8d1cd6fd358b9b7ca61f0f32ef0420da070e70c8a4885a79eeb5`
