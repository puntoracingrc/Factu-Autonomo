...
# Revisión fiscal · es-common.2026.model-180

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2026.model-180`
...
- Descripción de la decisión: Resumen anual de retenciones por alquiler

## Condiciones de inclusión

- Retenciones por alquiler declarables durante el ejercicio

## Candidatos de exclusión

- `es-common.2026.model-180.exclusion-1` · No hubo rentas sujetas al resumen · `ADVISORY_EXCLUSION_CANDIDATE`

## Excepciones

- No hubo rentas sujetas al resumen
...
- Declarada: `180.2026.positive`
- Declarada: `180.2026.negative`
- Declarada: `180.2026.exception`
- Declarada: `180.2026.incomplete`
- Declarada: `180.2026.census-mismatch`
- Declarada: `180.2026.year-boundary`
...
- `fiscal-closure.es-common.2026.model-180` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:8fa6359c8f8096ad9c3332d3e738a034d756e955c746d01fece6894ba4494670`
