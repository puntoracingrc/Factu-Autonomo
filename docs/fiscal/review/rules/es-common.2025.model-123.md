...
# Revisión fiscal · es-common.2025.model-123

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-123`
...
- `es-common.2025.model-123.exclusion-1` · Renta encuadrada en otro modelo específico · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `123.2025.positive`
- Declarada: `123.2025.negative`
- Declarada: `123.2025.exception`
- Declarada: `123.2025.incomplete`
- Declarada: `123.2025.census-mismatch`
- Declarada: `123.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-123` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:3fc9b018f3cb1b4b40618744a83d5fec98456931b787ce933dbacf258fbdf43a`
