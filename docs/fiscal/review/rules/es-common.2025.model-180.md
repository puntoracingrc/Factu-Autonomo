...
# Revisión fiscal · es-common.2025.model-180

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-180`
...
- `es-common.2025.model-180.exclusion-1` · No hubo rentas sujetas al resumen · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `180.2025.positive`
- Declarada: `180.2025.negative`
- Declarada: `180.2025.exception`
- Declarada: `180.2025.incomplete`
- Declarada: `180.2025.census-mismatch`
- Declarada: `180.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-180` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:8e304007b01aab1be65f22804170144f3ca0325e64ac4ea60a1226dd8e009291`
