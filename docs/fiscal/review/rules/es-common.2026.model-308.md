...
# Revisión fiscal · es-common.2026.model-308

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2026.model-308`
...
- Descripción de la decisión: Solicitud especial de devolución a revisar

## Condiciones de inclusión

- Supuesto específico de devolución previsto por la normativa

## Candidatos de exclusión

- `es-common.2026.model-308.exclusion-1` · Mera existencia de cuotas de IVA o resultado a devolver del 303 · `ADVISORY_EXCLUSION_CANDIDATE`

## Excepciones

- Mera existencia de cuotas de IVA o resultado a devolver del 303
...
- `aeat.model-308.procedure` · Modelo 308 · solicitudes de devolución · https://sede.agenciatributaria.gob.es/Sede/iva/modelo-308-iva-etos-pasivos-devolucion.html · snapshot pendiente
...
- Declarada: `308.2026.positive`
- Declarada: `308.2026.negative`
- Declarada: `308.2026.exception`
- Declarada: `308.2026.incomplete`
- Declarada: `308.2026.census-mismatch`
- Declarada: `308.2026.year-boundary`
...
- `fiscal-closure.es-common.2026.model-308` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:c998e1b2fc7e0936d635e7acefc70d9e9da84f7292cfb3d53adff33ac35428d4`
