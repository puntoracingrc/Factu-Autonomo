...
# Revisión fiscal · es-common.2025.model-341

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-341`
...
- `es-common.2025.model-341.exclusion-1` · No existe el supuesto especial · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `341.2025.positive`
- Declarada: `341.2025.negative`
- Declarada: `341.2025.exception`
- Declarada: `341.2025.incomplete`
- Declarada: `341.2025.census-mismatch`
- Declarada: `341.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-341` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:487976d8eb552836025ab4a1f2b6bd9a14ec4e732e5299ce83dff1504d396a89`
