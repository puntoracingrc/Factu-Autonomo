...
# Revisión fiscal · es-common.2026.model-309

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2026.model-309`
...
- Descripción de la decisión: Autoliquidación no periódica de IVA

## Condiciones de inclusión

- Sujeto sin autoliquidación periódica que realiza una operación no periódica declarable

## Candidatos de exclusión

- `es-common.2026.model-309.exclusion-1` · La operación ya se liquida en 303 · `ADVISORY_EXCLUSION_CANDIDATE`

## Excepciones

- La operación ya se liquida en 303
...
- `aeat.model-309.instructions` · Modelo 309 · instrucciones · https://sede.agenciatributaria.gob.es/Sede/todas-gestiones/impuestos-tasas/iva/modelo-309-iva-declaracion-liquidacion-periodica_/instrucciones-modelo-309.html · snapshot pendiente
...
- Declarada: `309.2026.positive`
- Declarada: `309.2026.negative`
- Declarada: `309.2026.exception`
- Declarada: `309.2026.incomplete`
- Declarada: `309.2026.census-mismatch`
- Declarada: `309.2026.year-boundary`
...
- `fiscal-closure.es-common.2026.model-309` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:ffa06c249b5519419b7b000fc211a1bc8e0e7a2e3326342ab2a15bf97814f3a8`
