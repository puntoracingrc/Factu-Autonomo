...
# Revisión fiscal · es-common.2025.model-190

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2025.model-190`
...
- `es-common.2025.model-190.exclusion-1` · No hubo rentas comprendidas · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `190.2025.positive`
- Declarada: `190.2025.negative`
- Declarada: `190.2025.exception`
- Declarada: `190.2025.incomplete`
- Declarada: `190.2025.census-mismatch`
- Declarada: `190.2025.year-boundary`
...
- `fiscal-closure.es-common.2025.model-190` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:02bd0eef818868a236acdcf6a19505b40a6fcf14ef8e9ce0dcc738d59b5766a5`
