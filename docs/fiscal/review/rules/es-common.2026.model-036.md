...
# Revisión fiscal · es-common.2026.model-036

> Expediente técnico sin firma. No constituye aprobación fiscal.

- Rule ID: `es-common.2026.model-036`
...
- `es-common.2026.model-036.exclusion-1` · No se ha producido ningún cambio censal · `ADVISORY_EXCLUSION_CANDIDATE`
...
- Declarada: `036.2026.positive`
- Declarada: `036.2026.negative`
- Declarada: `036.2026.exception`
- Declarada: `036.2026.incomplete`
- Declarada: `036.2026.census-mismatch`
- Declarada: `036.2026.year-boundary`
...
- `fiscal-closure.es-common.2026.model-036` · `OPEN`
...
- Hash fiscal actual: `fiscal-rule-v1:50574d19f15ae1c9d6528bc9db00025cde26ddf4d69480478cbd6654a70cc445`
