...
NEXT_PUBLIC_GOOGLE_MAPS_API_KEY=... # opcional: sugerir direcciones con Google Places
```
...
Crea una cuenta nueva sin pagar y verifica estos límites desde dos dispositivos:

- 15 documentos definitivos al mes; los borradores y las rectificativas no cuentan.
- 10 gastos manuales al mes.
- 15 clientes, 15 proveedores y 10 productos activos.

El siguiente intento debe quedar bloqueado, aparecer en Admin > Límites y mostrar la fecha exacta de reinicio cuando el límite sea mensual.
