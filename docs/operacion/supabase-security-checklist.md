...
- Recuperacion de contraseña: probar envio de enlace y cambio de contraseña en
...
- Recuperacion de contraseña: la app tiene flujo de enlace al email y formulario
  de nueva contraseña para cuentas con email/contraseña.
- Passwords: registro y cambio de contraseña validan minimo 12 caracteres; el
  login no bloquea a cuentas antiguas por longitud.
...
- Recuperacion de contraseña: no borrar `/auth/callback` ni bloquear
  `type=recovery`; el enlace de Supabase necesita volver a la app.
